...
impl App {
    ...
    pub(crate) fn request_backtrack(
        ...
        self.app_event_tx.send(crate::app_event::AppEvent::CodexOp(
            openx_core::protocol::Op::GetHistory,
        ));
    }
    ...
    async fn perform_fork(
        &self,
        entries: Vec<openx_protocol::models::ResponseItem>,
        drop_count: usize,
        cfg: openx_core::config::Config,
    ) -> openx_core::error::Result<openx_core::NewConversation> {
        self.server
    ...
    fn install_forked_conversation(
        ...
        tui: &mut tui::Tui,
        cfg: openx_core::config::Config,
        new_conv: openx_core::NewConversation,
        drop_count: usize,
        prefill: &str,
    ) {
