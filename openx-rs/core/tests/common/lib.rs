...
pub fn load_default_config_for_test(openx_home: &TempDir) -> Config {
    Config::load_from_base_config_with_overrides(
        ConfigToml::default(),
        ConfigOverrides::default(),
        openx_home.path().to_path_buf(),
    )
...
pub async fn wait_for_event<F>(
    ...
    predicate: F,
) -> openx_core::protocol::EventMsg
where
    F: FnMut(&openx_core::protocol::EventMsg) -> bool,
{
