    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("openx-linux-sandbox");
    spawn_child_async(
        openx_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `openx-linux-sandbox`.
