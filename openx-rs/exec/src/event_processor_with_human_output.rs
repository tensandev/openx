use openx_common::elapsed::format_duration;
use openx_common::elapsed::format_elapsed;
...
use openx_core::protocol::McpInvocation;
...
use openx_core::protocol::SessionConfiguredEvent;
...
use openx_common::create_config_summary_entries;
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(&mut self, config: &Config, prompt: &str) {
        ...
        ts_println!(
            self,
            "OpenAI OpenX v{} (research preview)\n--------",
            VERSION
        );
