//! Defines the protocol for a OpenX session between a client and an agent.
//!
...
pub enum Op {
    ...
    /// for a turn of a [`crate::openx_conversation::OpenXConversation`].
    UserTurn {
        /// User input items, see `InputItem`
        items: Vec<InputItem>,
...
/// running the command proposed by OpenX.
    ...
    fn serialize_event() {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id,
                model: "openx-mini-latest".to_string(),
                history_log_id: 0,
        ...
        assert_eq!(
            serialized,
            r#"{"id":"1234","msg":{"type":"session_configured","session_id":"67e55044-10b1-426f-9247-bb680e5fe0c8","model":"openx-mini-latest","history_log_id":0,"history_entry_count":0}}"#
        );
    }
