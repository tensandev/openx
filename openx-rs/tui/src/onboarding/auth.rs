...
impl AuthModeWidget {
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "> ".into(),
                "Sign in with ChatGPT to use OpenX as part of your paid plan".bold(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant OpenX".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                "\u{1b}]8;;https://github.com/openai/codex\u{7}OpenX docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
            "  OpenX can make mistakes".into(),
    ...
    fn render_env_var_missing(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            "  To use OpenX with the OpenAI API, set OPENAI_API_KEY in your environment"
                .fg(Color::Cyan)
                .into(),
            "".into(),
