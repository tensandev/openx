...
use openx_core::model_family::find_family_for_model;
...
use openx_core::shell::default_user_shell;
...
async fn openx_mini_latest_tools() {
    ...
    config.model = "openx-mini-latest".to_string();
    config.model_family = find_family_for_model("openx-mini-latest").unwrap();
