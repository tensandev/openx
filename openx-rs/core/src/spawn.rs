...
///
/// 1. The process was spawned by OpenX as part of a shell tool call.
...
pub(crate) async fn spawn_child_async(
    ...
    // If this OpenX process dies (including being killed via SIGKILL), we want
    ...
    unsafe {
        cmd.pre_exec(|| {
            ...
            // run _after_ the parent (i.e., the OpenX process) has already
