...
use openx_apply_patch::ApplyPatchAction;
use openx_apply_patch::MaybeApplyPatchVerified;
use openx_apply_patch::maybe_parse_apply_patch_verified;
use openx_protocol::protocol::ConversationHistoryResponseEvent;
use openx_protocol::protocol::TaskStartedEvent;
use openx_protocol::protocol::TurnAbortReason;
use openx_protocol::protocol::TurnAbortedEvent;
use serde::Serialize;
use serde_json;
...
use crate::apply_patch::OPENX_APPLY_PATCH_ARG1;
...
use openx_protocol::config_types::ReasoningEffort as ReasoningEffortConfig;
use openx_protocol::config_types::ReasoningSummary as ReasoningSummaryConfig;
use openx_protocol::custom_prompts::CustomPrompt;
use openx_protocol::models::ContentItem;
use openx_protocol::models::FunctionCallOutputPayload;
use openx_protocol::models::LocalShellAction;
use openx_protocol::models::ResponseInputItem;
use openx_protocol::models::ResponseItem;
use openx_protocol::models::ShellToolCallParams;
...
/// The high-level interface to the OpenX system.
...
/// Wrapper returned by [`OpenX::spawn`] containing the spawned [`OpenX`],
/// the submission id for the initial `ConfigureSession` request and the
/// unique session id.
pub struct OpenXSpawnOk {
    pub codex: OpenX,
    pub session_id: Uuid,
}
...
impl OpenX {
    /// Spawn a new [`OpenX`] and initialize the session.
    pub async fn spawn(
        config: Config,
        auth_manager: Arc<AuthManager>,
        conversation_history: InitialHistory,
    ) -> CodexResult<OpenXSpawnOk> {
        ...
        // Generate a unique ID for the lifetime of this OpenX session.
        ...
        Ok(OpenXSpawnOk { codex, session_id })
    }
    ...
    /// Use sparingly: prefer `submit()` so OpenX is responsible for generating
...
impl Session {
    async fn new(
        ...
        let sess = Arc::new(Session {
            ...
            openx_linux_sandbox_exe: config.openx_linux_sandbox_exe.clone(),
    ...
    async fn run_exec_with_events<'a>(
        ...
        let result = process_exec_tool_call(
            ...
            exec_args.openx_linux_sandbox_exe,
...
async fn submission_loop(
    ...
    while let Ok(sub) = rx_sub.recv().await {
        ...
        match sub.op {
                        ...
                        msg: EventMsg::GetHistoryEntryResponse(
                            crate::protocol::GetHistoryEntryResponseEvent {
                                ...
                                entry: entry_opt.map(|e| {
                                    openx_protocol::message_history::HistoryEntry {
            ...
            Op::Shutdown => {
                info!("Shutting down OpenX instance");
...
pub struct ExecInvokeArgs<'a> {
    ...
    pub openx_linux_sandbox_exe: &'a Option<PathBuf>,
    ...
    let (params, safety, command_for_display) = match &apply_patch_exec {
        Some(ApplyPatchExec {
            ...
            let params = ExecParams {
                command: vec![
                    path_to_codex,
                    OPENX_APPLY_PATCH_ARG1.to_string(),
                    patch.clone(),
                ],
                cwd: cwd.clone(),
                timeout_ms: params.timeout_ms,
    ...
    let output_result = sess
        .run_exec_with_events(
            ...
            ExecInvokeArgs {
                ...
                openx_linux_sandbox_exe: &sess.openx_linux_sandbox_exe,
